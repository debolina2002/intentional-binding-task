...
expName = 'intentional binding_tutorial 7'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\debol\\Desktop\\PsychoPy\\intentional binding_tutorial 7_lastrun.py',
...
trials = data.TrialHandler(nReps=5.0, method='random', 
    ...
    trialList=data.importConditions('C:/Users/debol/Desktop/PsychoPy/ib_conditions.xlsx'),
